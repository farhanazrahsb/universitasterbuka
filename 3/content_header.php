<header class="main-header">
  <!-- Logo -->
  <div class="logo">
<span class="logo-mini"><img src="../img/ut.png" class="img-circle" alt="Logo" height="50" width="50"></span>
<span class="logo-lg"><b>Universitas Terbuka</b></span>
</div>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <p>Welcome To Universitas Terbuka</p>
            </li>
            <!-- Menu Footer-->
